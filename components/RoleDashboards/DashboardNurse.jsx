...
// Fonction pour obtenir la date d'aujourd'hui au format souhaité
const getTodayDate = () => {
...
export const DashboardNurse = ({ firstName, lastName }) => {
    ...
    >
      ...
      >
        <div>
          ...
          <p style={{ color: "white", fontSize: "1.2rem" }}>{todayDate}</p>
        </div>
        <div>
